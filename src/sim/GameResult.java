 ...
 * @param insolvencies     episodios de insolvencia (ec. 5.2) en toda la partida
...
public record GameResult(String experiment, String parameter, double value, long seed,
                         String winnerId, int turns, int insolvencies,
                         int winnerProvinces, int winnerTroops) {

    public static String csvHeader() {
        return "experimento,parametro,valor,semilla,ganador,turnos,insolvencias,provincias_ganador,tropas_ganador";
    }

    public String toCsvRow() {
        return String.format(java.util.Locale.ROOT, "%s,%s,%s,%d,%s,%d,%d,%d,%d",
                experiment, parameter, trimmed(value), seed, winnerId,
                turns, insolvencies, winnerProvinces, winnerTroops);
    }
